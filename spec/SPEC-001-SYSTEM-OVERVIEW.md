...
AgentX Agentic RAG 是一个**智能知识平台**，让用户能够：
- 创建专业领域的 AI 知识库（如法律领域、财务领域、技术领域）
- 通过上传文档让领域学习专业知识
- 与领域进行智能对话，获得专业、有依据的回答
- 领域会持续学习用户偏好，提供个性化服务
...
**详细特性文件**: [features/domain/002-create-domain.feature](./features/domain/002-create-domain.feature)
...
| 术语 | 定义 |
|------|------|
| 领域 (Domain) | 用户创建的 AI 知识库实体，对应一个工作区 |
...
| 3.0.0 | 2024-12-19 | AI Coder | 术语重构：助手(Assistant) → 领域(Domain) |
