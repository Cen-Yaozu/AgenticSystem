...
参考 Feature 文件：
- [002-create-domain.feature](../features/domain/002-create-domain.feature)
- [002-query-domain.feature](../features/domain/002-query-domain.feature)
- [002-update-domain.feature](../features/domain/002-update-domain.feature)
- [002-delete-domain.feature](../features/domain/002-delete-domain.feature)

---

## 5. Phase 2: 文档处理（Week 4-5）✅ 已完成
...
| 实现领域角色激活（promptx_action） | P0 | 4h | MCP 客户端 |
| 实现子代理角色激活 | P0 | 4h | 领域角色 |
