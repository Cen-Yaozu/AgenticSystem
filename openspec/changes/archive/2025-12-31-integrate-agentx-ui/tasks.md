...
- [x] 4.1 功能测试
  ...
  - 测试 Markdown 渲染
  - 测试代码高亮和复制
  - ✅ 已验证：Markdown 渲染正常、代码高亮正常、复制按钮正常、WebSocket 连接正常
  - ✅ 修复：添加 parseMessageContent 函数解析 JSON 格式的消息内容
  - ✅ 修复：ChatPage 输入框消失问题 - 将 ChatPage 移出 Layout 包装，修复 flex 布局
  - ✅ 修复：对话功能不工作问题 - 兼容 AgentX 的 text_delta/conversation_start/conversation_end/message_stop 事件格式
